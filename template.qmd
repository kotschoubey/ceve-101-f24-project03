...
This data is not completely sufficient to run an accurate or meaninful risk assessment. There is no data covering rainfall from 2005 to 2007, so there is not enough data to accurate measure rainfall over the 8 year period shown.
...
The average household usage of water per day is around 1,200 liters. This is clearly a much larger amount than is expected from families in this study, and I think it is a high expectation for my family, as we do not have a yard that needs watering. However, we do have 4 people who shower, eat, and use the restroom every day, so we definitely use more water than 74.1 liters a day.
...
I chose a roof of 30 square meters to see what would happen if the family had a smaller house. However, because there is less surface area to collect rain from, I increased the runoff coefficent to 0.95, because I thought it would be more accurate to the situation. I also increased the first flush to 3 mm to account for particularly dirty or dusty conditions. 
...
The tank definitely becomes full around late April and could overflow. This means that there is a certain amount of rainwater that will never get collected. At the end of the year, the tank gets very close to empty as there has been no rainfall since June or July. However, the tank never runs dry.

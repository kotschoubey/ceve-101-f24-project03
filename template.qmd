...
The data provide lots of information over a long period of time: from around 1975 to 2023. This is enough information to assess risk in the future, but the current graph provided is not the only graph we will need. It is hard to read the specific data about different times of the year. It's almost impossible to tell exactly how long (yearwise) the gaps are. If there were more marks signifying each year, that would be helpful. We are also missing several data points from several years, namely from around 1981, 1997, and 2010-2011. We also don't have additional data we need about droughts, particularly rainy seasons, floods, and other natural disasters. 
